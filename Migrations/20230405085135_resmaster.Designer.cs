...
namespace RMS.Migrations
{
    ...
    [Migration("20230405085135_resmaster")]
    partial class resmaster
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RMS.Models.HREmpDetails", b =>
                {
                    ...
                    b.Property<int?>("ResSalesMasterRSMId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResSalesMasterRSMId");
            ...
            modelBuilder.Entity("RMS.Models.HREmpDetails", b =>
                {
                    ...
                    b.HasOne("RMS.Models.ResSalesMaster", null)
                        .WithMany("HREDEName")
                        .HasForeignKey("ResSalesMasterRSMId");
            ...
            modelBuilder.Entity("RMS.Models.ResSalesDetails", b =>
                {
                    b.HasOne("RMS.Models.ResMenu", "ResMenu")
                        .WithMany()
                        .HasForeignKey("RMId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
